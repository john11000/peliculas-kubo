      ...
      <q-card-section horizontal>
        ...
        <q-card-section class="col-5 flex flex-center">
          <q-img
            ...
            :src="`https://b-peliculas.herokuapp.com/img/` + pelicula.caratula"
          />
        </q-card-section>
      </q-card-section>
...
export default defineComponent({
  ...
  beforeCreate: async function () {
    ...
    const historial = await axios.get("https://b-peliculas.herokuapp.com/movies/historial")
  ...
  methods: {
    ...
    calificar: async function () {
      const res = await axios.post("https://b-peliculas.herokuapp.com/movies/calificar", {
